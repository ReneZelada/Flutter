...
class _HomeState  extends State<Home>{
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> usersStream = FirebaseFirestore.instance.collection('Tasks').snapshots();
                            ...
                            ListView(
                              ...
                              children: snapshot.data!.docs.map((DocumentSnapshot document) {
                                ...
                                return   Card(
                                  ...
                                  child: InkWell(
                                    onTap: () => {
                                      GlobalNavigator.showConfirmDialog("Alert", "Esta seguro de marcar la tarea como completada?", document.id)
                                    },
                                    child:Padding(
